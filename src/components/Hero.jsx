    ...
    <section id="hero" className="min-h-screen flex items-center justify-center pt-20 px-6 relative">
      <div className="text-center z-10 w-full max-w-5xl flex flex-col items-center">
        ...
        >
          ...
          <a href="/resume.pdf" target="_blank" rel="noreferrer" className="px-8 py-4 bg-transparent text-white border border-surfaceBorder hover:border-white font-semibold tracking-wide hover:bg-white/5 transition-all w-full sm:w-auto">
            Résumé
          </a>
        </motion.div>
      </div>
